...
## incidents_f2 <- incidents_f %>% mutate_geocode(Full_Location)
...
perps <- read_csv("data/ss_perps.csv", na = c("", "null", "N/A"), 
                  show_col_types = F)
weapons <- read_csv("data/ss_weapons.csv", na = c("", "null", "N/A"),
                    show_col_types = F)
...
csr_plot +
  plot_annotation(
    caption = "Data was simulated from an intercept only Poisson process model."
  )
```
